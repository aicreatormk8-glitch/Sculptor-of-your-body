...
const weeks = [
  {
    range: "Недели 1–2",
    title: "Адаптация и техника",
    desc: "Знакомство с нагрузкой, освоение правильной техники, подготовка тела к работе.",
    color: "rgba(0,100,200,0.5)",
  },
  {
    range: "Недели 3–4",
    title: "Рост нагрузки",
    desc: "Постепенное увеличение интенсивности, активация целевых мышечных групп.",
    color: "rgba(0,150,220,0.5)",
  },
  {
    range: "Недели 5–6",
    title: "Усиление акцента",
    desc: "Фокус на ягодицах и проблемных зонах, прогрессия нагрузки на пике.",
    color: "rgba(0,180,240,0.5)",
  },
  {
    range: "Недели 7–8",
    title: "Финальная трансформация",
    desc: "Максимальный результат, видимые изменения формы и ощущение силы тела.",
...
const includes = [
  ...
  "Акцент на ягодицы и форму тела",
  "Структура по неделям с прогрессией",
...
export default function Program() {
  return (
    <section id="program" className="section-padding relative overflow-hidden">
      ...
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] blur-[180px] pointer-events-none"
        style={{ background: "rgba(0,80,180,0.07)" }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-800 text-white mb-4">
            8 недель до твоей{" "}
            <span className="text-[var(--blue-neon)]">лучшей версии</span>
          </h2>
          <p className="text-[var(--text-secondary)] max-w-xl mx-auto">
            Программа создана для девушек, которые хотят подтянуть тело, сделать акцент на ягодицы,
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <AnimatedSection delay={0.1}>
            <h3 className="text-sm font-600 tracking-[0.2em] uppercase text-[var(--text-muted)] mb-8">
              Структура программы
            </h3>
            <div className="relative">
              ...
              <div
                ...
                style={{ background: "linear-gradient(to bottom, var(--blue-neon), transparent)" }}
              />
                    ...
                    <div className="flex gap-6">
                      ...
                      <div className="relative z-10 flex-shrink-0">
                        <div
                          ...
                          style={{
                            background: `radial-gradient(circle, ${w.color}, rgba(0,40,80,0.8))`,
                            border: "1px solid rgba(0,212,255,0.4)",
                            boxShadow: `0 0 20px ${w.color}`,
                          }}
                        >
                          {i + 1}
                        </div>
                      ...
                      <div className="glass rounded-2xl p-4 flex-1">
                        <span className="text-xs font-600 tracking-wider text-[var(--blue-neon)] uppercase">
                          {w.range}
                        </span>
          ...
          <AnimatedSection delay={0.2} direction="right">
            <div
              className="rounded-2xl p-7 sm:p-8 glow-border"
              style={{
                background: "linear-gradient(145deg, rgba(0,40,100,0.6), rgba(0,15,40,0.8))",
                backdropFilter: "blur(20px)",
              }}
            >
              {/* Badge */}
              <div
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-700 mb-6"
                style={{
              ...
              <p className="text-sm text-[var(--text-muted)] mb-6">8-недельная программа трансформации</p>

              {/* Price */}
              <div className="flex items-baseline gap-3 mb-6">
                <span
                  className="text-5xl font-800"
                  style={{ color: "var(--blue-neon)", textShadow: "0 0 30px rgba(0,212,255,0.5)" }}
                >
                  $33
                </span>
              ...
              {/* CTA — redirects to Telegram after payment */}
              <a
                href="#contact"
                onClick={(e) => {
                  e.preventDefault();
              ...
              <p className="text-center text-xs text-[var(--text-muted)] mt-4">
                После оплаты — мгновенный доступ к программе
              </p>
            </div>
          </AnimatedSection>
        </div>
