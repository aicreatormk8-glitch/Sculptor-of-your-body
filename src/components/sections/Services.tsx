              ...
              >
                {s.tag && (
                  <motion.div
                    ...
                    style={["SALE", "ФЛАГМАН"].includes(s.tag)
                ...
                <motion.a
                  ...
                  className="text-center text-sm font-700 tracking-wide uppercase whitespace-nowrap cursor-pointer rounded-full px-8 py-3.5"
                  style={s.featured
